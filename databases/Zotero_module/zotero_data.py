...
note_update =\
    {
        "Study Objectives, Research Problem, Research Questions": "Analyze the provided Markdown-formatted research paper and extract at least two occurrences (and up to four) for the following research elements: Study Objectives, Research Problem, and Research Questions. For each section, summarize and rephrase the relevant information using indirect citations, ensuring proper attribution and formatting. Follow the general formatting guidelines: 1. Use headers ## Study Objectives, ## Research Problem, and ## Research Questions to group sections. 2. Each section must contain at least two and up to four occurrences of the relevant research element. 3. Format each item using a callout box structure: '> [!info] **[Title]:** [Explanation of the research element]. ([Author, Year](filename#^ID)).' 4. Provide indirect rephrasing and do not use direct quotes. Keymapping: {'study_objectives': ['objective', 'goal', 'purpose', 'aim', 'target', 'intention', 'mission', 'priority', 'focus', 'intended outcome'], 'research_problem': ['problem', 'challenge', 'issue', 'difficulty', 'dilemma', 'obstacle', 'concern', 'complication', 'hurdle', 'trouble'], 'research_questions': ['question', 'inquiry', 'investigation', 'query', 'puzzle', 'problem statement', 'research query', 'uncertainty', 'examination', 'interrogation']}}.note 1: only valid ids are used for reference and reference format is strictly validated before outputting. output:raw valid md text in codeblock",
        "Research Framework": "Analyze the provided Markdown-formatted research paper and extract at least two occurrences (and up to four) for the following research elements: Research Questions and Hypotheses. For each section, summarize and rephrase the relevant information using indirect citations, ensuring proper attribution and formatting. Follow the general formatting guidelines: 1. Use headers ## Research Questions and ## Hypotheses to group sections. 2. Each section must contain at least two and up to four occurrences of the relevant research element. 3. Format each item using a callout box structure: '> [!info] **[Title]:** [Explanation of the research element]. ([Author, Year](filename#^ID)).' 4. Provide indirect rephrasing and do not use direct quotes. Keymapping: {{'research_questions': ['question', 'inquiry', 'investigation', 'query', 'puzzle', 'problem statement', 'research query', 'uncertainty', 'examination', 'interrogation'], 'hypotheses': ['hypothesis', 'hypotheses', 'propose', 'theory', 'assumption', 'premise', 'supposition', 'postulation', 'conjecture', 'guess']}}.note 1: only valid ids are used for reference and reference format is strictly validated before outputting. output:raw valid md text in codeblock",
        "Shortcomings Limitations</h2>": "Analyze the provided Markdown-formatted research paper and extract at least two occurrences (and up to four) for the following research elements: Limitations and Contributions. For each section, summarize and rephrase the relevant information using indirect citations, ensuring proper attribution and formatting. Follow the general formatting guidelines: 1. Use headers ## Limitations and ## Contributions to group sections. 2. Each section must contain at least two and up to four occurrences of the relevant research element. 3. Format each item using a callout box structure: '> [!info] **[Title]:** [Explanation of the research element]. ([Author, Year](filename#^ID)).' 4. Provide indirect rephrasing and do not use direct quotes. Keymapping: {{'limitations': ['limitation', 'limit', 'restriction', 'constraint', 'boundary', 'shortcoming', 'drawback', 'weakness', 'deficiency', 'hindrance'], 'contributions': ['contribute', 'contribution', 'advance', 'innovation', 'input', 'enhancement', 'improvement', 'addition', 'offering', 'support']}}.note 1: only valid ids are used for reference and reference format is strictly validated before outputting. output:raw valid md text in codeblock",
        "Research Gap and Future Research Directions</h2>": f"Analyze the provided Markdown-formatted research paper and extract at least two occurrences (and up to four) for the following research elements: Research Gap, Future Research Direction, and Contributions. For each section, summarize and rephrase the relevant information using indirect citations, ensuring proper attribution and formatting. Follow the general formatting guidelines: 1. Use headers ## Research Gap, ## Future Research Direction, and ## Contributions to group sections. 2. Each section must contain at least two and up to four occurrences of the relevant research element. 3. Format each item using a callout box structure: '> [!info] **[Title]:** [Explanation of the research element]. ([Author, Year](filename#^ID)).' 4. Provide indirect rephrasing and do not use direct quotes. Keymapping: {{'research_gap': ['gap', 'deficiency', 'lacuna', 'shortfall', 'absence', 'void', 'incomplete', 'lack', 'missing element', 'unexplored area'], 'future_research_direction': ['future direction', 'recommendation', 'next steps', 'future work', 'suggestion', 'research agenda', 'proposal', 'long-term focus', 'further investigation', 'potential avenue'], 'contributions': ['contribute', 'contribution', 'advance', 'innovation', 'input', 'enhancement', 'improvement', 'addition', 'offering', 'support']}}.note 1: only valid ids are used for reference and reference format is strictly validated before outputting. output:raw valid md text in codeblock",
        # "<h2>1.5 Structure and Keywords</h2>": [
        ...
        #     "Guidelines: Analyze the document and extract: 1. Bibliographic information: <h4> Bibliographical Information</h4><ul> <li>Citation style: [analyse the whole document and search for intext citations. if numerical citations like \"cyberspace can be dangerous5\" are found return here numerical. if APA style like author year (Smith, 2022), return APA]</li> <li>Bibliographic position: [In-text or End]</li> </ul> 2. Academic fields (list three primary disciplines with at least two of each): <h4>Academic Fields</h4><ul> <li>Field: [Field found in the article]</li> <li>Research area: [Research area found in the article]</li> </ul> 3. Topics (list up to seven themes, each up to four words): <h4>Themes and Topics:</h4> <ul> <li>TI don't know. opic: [Theme or Topic found in the article, list up to seven themes, each up to four words]</li> </ul> 4. Research information: <h4>Research information</h4><ul> <li>Research type: [The research type, e.g., Qualitative, Quantitative, Mixed Methods, Experimental, Longitudinal]</li> <li>Research design: [The research design, e.g., Treaty Analysis, Comparative Policy Analysis, Normative Legal Analysis]</li> <li>Data type: [The data type found in the text]</li> 5. Data Collection Methods:<h4>Data Collection Methods</h4> <li>Method:[Method used by the author, e.g., Archival Research, Structured Interviews, Policy Review. If more than one method, create another list in the same format data collection method[method]]</li> </ul>note1 . [] are commands, do not print []. note 2 output in a code block"
